...
![](http://njwilson23.github.com/irlib/images/repo_image.png)
...
- **IcePick2**: Development version of an application that combines the three
  above
...
bit the development period may be a bit turbulent. Consider trying the
*stable-0.3* branch if problems crop up.
